...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<table cellspacing="0">
		...
		<tr class="order-total">			
			<td colspan="2"><strong><?php _e( 'Total', 'woocommerce' ); ?></strong> <span><?php wc_cart_totals_order_total_html(); ?></span></td>
		</tr>
	...
	<div class="continue-shopping">
		<a href="<?php echo get_bloginfo('url');?>/shop">Continue Shopping</a>
	</div>

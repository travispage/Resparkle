...
if ($quantity_min === $quantity_max || $bundled_item->is_out_of_stock()) { ?>
    ...
    <div class="quantity quantity_hidden" style="display:none;">
    <input class="qty bundled_qty" type="hidden"
           name="<?php echo $bundle_fields_prefix; ?>bundle_quantity_<?php echo $bundled_item->item_id; ?>"
           value="<?php echo $quantity_min; ?>"/>
    <label for="<?php echo $bundle_fields_prefix; ?>bundle_quantity_<?php echo $bundled_item->item_id; ?>">Please select
        quantity</label>
    </div><?php
    ...
    echo '<div class="bundle-qty-form">';
    ...
    echo '<p class="bundle-qty-desc">Select Quantity Between '.$quantity_min.' and '.$quantity_max;
    echo '</div>';

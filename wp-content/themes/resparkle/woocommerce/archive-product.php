...
get_header( 'shop' ); ?>
	...
	<div class="masthead">
		<img src="<?php echo get_template_directory_uri();?>/assets/mastheads/Maskhead_Shop.jpg"/>
	</div>
	<div class="cat-nav">
		<?php
		...
		<ul>
			...
			<?php foreach($prod_cats as $cat): ?>
				<li <?php echo ($current_cat == $cat->slug ? 'class="active"' : '');?>><a href="<?php echo get_bloginfo('url').'/product-category/'.$cat->slug;?>"><?php echo $cat->name;?></a></li>
			<?php endforeach; ?>

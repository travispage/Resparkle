	...
	<?php if ( ! empty( $actions ) ) : ?>
		<tr>
			...
			<td>
				...
				<?php endforeach; ?>
				<br>
					<span style="font-size: 15px">For more flexibility with your order, you may also choose to PAUSE during the time you do not need a delivery, and RESUME after.</span>
				</br>
			</td>
		</tr>
	<?php endif; ?>

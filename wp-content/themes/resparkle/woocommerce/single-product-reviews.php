...
<br class="clear"/>
<div id="reviews">
	<h1 class="sec-title">REVIEWS</h1>
	<div id="comments" <?php echo ( have_comments() ? '' : 'class="no-reviews"' ) ;?>>
		<div>
	...
	<?php else : ?>
		...
		<?php /* <p class="woocommerce-verification-required"><?php _e( 'Only logged in customers who have purchased this product may leave a review.', 'woocommerce' ); ?></p> */ ?>

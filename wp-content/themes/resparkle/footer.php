		...
		*/
		...
		if(jQuery('.thumbnails img').length > 0) {
			jQuery('.thumbnails img').on('click',function(e){
				...
				jQuery('.woocommerce-main-image').html(img);
			});
		}
...
<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-P7N6DX"
...
fbq('init', '1036674069746625');
fbq('track', "PageView");</script>
<noscript><img height="1" width="1" style="display:none"
src="https://www.facebook.com/tr?id=1036674069746625&ev=PageView&noscript=1"
/></noscript>

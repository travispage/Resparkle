...
use WbsVendors\Dgm\Shengine\Conditions\Common\Stub\TrueCondition;
    ...
    private function makeChargeCalculator(array $_rule)
    {
        ...
        foreach ($_classCharges as $_classCharge) {
            ...
            $perClassRules[] = new Rule(
                new RuleMeta(),
                new RuleMatcher(
                    new RuleMatcherMeta(true, new AttributeGrouping(new ItemAttribute())),
                    new TermsCondition(array(IItemAggregatables::TAXONOMY_SHIPPING_CLASS => array($_class)))
                ),
        ...
        $defaultClassRule = new Rule(
            new RuleMeta(),
            new RuleMatcher(
                new RuleMatcherMeta(true, new FakeGrouping()),
                new TrueCondition()
            ),

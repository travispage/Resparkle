...
echo '<tr>';
echo '<td colspan="2">';
echo '<div id="wc_aelia_cs_bundle_prices" class="variation clearfix show_if_variable-bundle">';
...
$signup_prices = Bundles_Integration::get_bundle_variation_signup_prices($post_id);
...
foreach($enabled_currencies as $currency) {
	...
	woocommerce_wp_text_input(array('id' => Bundles_Integration::FIELD_VARIATION_SIGNUP_FEE_CURRENCY_PRICES . "[$loop][$currency]",
	...
	woocommerce_wp_text_input(array('id' => Bundles_Integration::FIELD_VARIATION_REGULAR_CURRENCY_PRICES . "[$loop][$currency]",
																	'class' => 'wc_input_price short',
																	'label' => '',
																	'type' => 'number',
	...
	echo '<td class="Sale">';
	woocommerce_wp_text_input(array('id' => Bundles_Integration::FIELD_VARIATION_SALE_CURRENCY_PRICES . "[$loop][$currency]",
																	'class' => 'wc_input_price short',
																	'label' => '',
																	'type' => 'number',

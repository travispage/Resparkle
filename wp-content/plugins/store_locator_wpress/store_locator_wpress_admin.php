...
class Store_locator_wpress_admin {
	...
	function Store_locator_wpress_admin() {
		...
		if($a1->verify_activation()) {
			...
			if(is_admin()) {
				wp_enqueue_script('gmap_api', 'http://maps.google.com/maps/api/js?sensor=false&region=au', array('jquery'));
	...
	function store_locator_edit() {
		...
		<div class="metabox-holder">
			...
			if(isset($_POST['update'])) {
				...
				$criteria['postal_code'] = $_POST['postal_code'];
				...
				echo '<form id="add_store_form2" method="post">';
					...
					echo '<p><label>Postal Code</label></p>';
					echo '<p><input class="widefat" type="text" name="postal_code" value="'.$store[0]['postal_code'].'"></p>';
		...
		<div class="metabox-holder">
			...
			if(isset($_POST['update'])) {
				...
				echo '<form id="add_store_form2" method="post" style="display:none;">';
					...
					echo '<p><label>Postal Code</label></p>';
					echo '<p><input class="widefat" type="text" name="postal_code"></p>';

...
function store_locator_load() {
	...
	if( address == '' ) Store_wpress.postal = 'undefined';
...
function display_map() {
	...
	jQuery.ajax({
		...
		dataType: 'json',
		data: 'action=store_wpress_listener&method=display_map&page_number=' + Store_wpress.page_number + '&postal=' + Store_wpress.postal + '&lat=' + lat + '&lng=' + lng + '&category_id=' + Store_wpress.category_id + '&radius_id=' + Store_wpress.radius_id + '&nb_display=' + nb_display,
...
function display_stores_list() {
	...
	jQuery.ajax({
		...
		url: Store_wpress.ajaxurl,
		dataType: 'json',
		data: 'action=store_wpress_listener&method=display_list&page_number=' + Store_wpress.page_number + '&postal=' + Store_wpress.postal + '&lat=' + lat + '&lng=' + lng + '&category_id=' + Store_wpress.category_id + '&radius_id=' + Store_wpress.radius_id + '&nb_display=' + nb_display + '&display_type=' + jQuery('body').data('type'),
		success: function(msg) {
			jQuery('#stores_locator_title').html(msg.title);
			jQuery('#previousNextButtons').html(msg.previousNextButtons);
			if (jQuery('#previousNextButtons2').length > 0) jQuery('#previousNextButtons2').html(msg.previousNextButtons);
	...
	jQuery('body').on('click','#store_locator_list a',function(e){
		e.preventDefault();
		btn = jQuery(this);
		...
		// marker.setMap(map);
		store_wpress_map.panTo(myLatlng);
		store_wpress_map.setZoom(18);
	});
}

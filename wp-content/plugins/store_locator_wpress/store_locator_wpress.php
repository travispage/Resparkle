<?php
/*
Plugin Name: Store Locator for Resparkle
Description: Customized Store Locator Plugin for Resparkle
Version: 2.1
Author: FLINT Creative
Author URI: http://flcs.co
*/
...
$GLOBALS['store_locator_lang']['more_details'] = '';
...
$GLOBALS['store_locator_lang']['search_by_address'] = '';
...
class Store_locator_wpress {
	...
	function store_wpress_listener() {
		...
		if($method=='display_map') {
			...
			$locations =  $sdb1->get_locations(array('postal' => $postal, 'lat'=>$lat, 'lng'=>$lng, 'page_number'=>$page_number, 'nb_display'=>$nb_display, 
			...
			$stores2 =  $sdb1->get_locations(array('postal' => $postal, 'lat'=>$lat, 'lng'=>$lng,
			'distance_unit'=>$distance_unit, 'category_id'=>$category_id, 'category2_id'=>$category2_id, 'radius_id'=>$radius_id));
		...
		//display stores list
			...
			$stores =  $sdb1->get_locations(array('postal' => $postal, 'lat'=>$lat, 'lng'=>$lng, 'page_number'=>$page_number, 'nb_display'=>$nb_display, 
			'distance_unit'=>$distance_unit, 'category_id'=>$category_id, 'category2_id'=>$category2_id, 'radius_id'=>$radius_id));

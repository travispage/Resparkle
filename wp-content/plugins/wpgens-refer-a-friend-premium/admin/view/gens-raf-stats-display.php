...
?>
<div style="background-color:#9A59B5;min-height:120px;margin-left:-20px;">
    <h1 style="color:#fff;margin:0;line-height:120px;margin-left:25px;">Refer a Friend by WPGens</h1>
</div>

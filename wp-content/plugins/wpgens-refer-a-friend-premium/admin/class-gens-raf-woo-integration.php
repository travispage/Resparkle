	...
	public function get_settings( $current_section = '' ) {
		...
		switch ($current_section) {
			case 'emails':
				$settings = array(
					...
					array(
						...
						'default' 		=> __( 'You referred someone! Here is your coupone code reward: {{code}} .', 'gens-raf')
					),
					array(
					...
					array(
						...
						'default' 		=> __( 'You purchased through referral link and earned coupon! Here is your coupone code reward: {{code}} .', 'gens-raf')
					),
					array(
						'id'		=> '',
			...
			case 'share':
				$settings = array(
					array(
						'name' => __( 'Configure share options', 'gens-raf' ),
						'type' => 'title',
						'id'   => 'plugin_options',
					),
					array(
					...
					array(
						...
						'type' 			=> 'text',
						'class'         => 'input-text wide-input',
						'desc'			=> __( 'Subject of an email that is sent when user shares his URL via email.', 'gens-raf'),
					),
					array(
						'id'			=> $prefix.'email_body',
						'name' 			=> __( 'Email Body (use HTML)', 'gens-raf' ),
						'type' 			=> 'textarea',
						'class'         => 'input-text wide-input',
						'desc'			=> __( 'Body text of the email that is sent when user shares his referral url via email. Use {{code}} for referral link code.Check the look of the email by sending the email to yourself.', 'gens-raf'),
					),
					array(
						'id'		=> '',
					...
					array(
						...
						'desc' => sprintf( __( 'Thanks for supporting Refer a Friend plugin by purchasing premium version. <br/>
							...
							<ul>
								...
								<li>2. Click on Product Tab option and populate tab text, or turn it off. You can use "gens_tab_filter_before" and "gens_tab_filter_after" filters to easily add text before and after RAF tab text/share icons.</li>
			...
			default:
				$settings = array(
					...
					array(
						...
						'type' 		=> 'checkbox',
						'desc_tip'	=> __( 'By default, if user sends referral link to other user that is registered on your site and has at least one order, referral link will not work for them. If you check this, then user can get reward for sharing referral link with both new and existing shop members.', 'gens-raf'),
						'desc' 		=> __( 'If unchecked, it means that users can get coupons when referring only new shop members and not existing ones.' ),
					),
					array(

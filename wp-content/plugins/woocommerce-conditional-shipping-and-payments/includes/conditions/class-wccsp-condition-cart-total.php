...
class WC_CSP_Condition_Cart_Total extends WC_CSP_Condition {
	...
	public function get_condition_resolution( $data, $args ) {
		...
		$cart_contents_tax = apply_filters( 'woocommerce_csp_cart_total_condition_incl_tax', true, $data, $args ) ? array_sum( WC()->cart->taxes ) : 0.0;

		$cart_total = WC()->cart->cart_contents_total + $cart_contents_tax;

	...
	public function get_settings() {
		...
		return apply_filters( 'woocommerce_csp_settings', array(
			...
			array(
				...
				'type'  => 'title',
				'desc'  => __( 'Use Restrictions to conditionally disable Payment Gateways, Shipping Methods and Shipping Countries or States.', 'woocommerce-conditional-shipping-and-payments' ),
			...
			array(
				...
				'type'  => 'title',
				'desc'  => __( 'Use the following options to temporarily disable all defined Restrictions, for example if you need to troubleshoot your payment and shipping settings.', 'woocommerce-conditional-shipping-and-payments' ),
			...
			array(
				...
				'type'          => 'checkbox',
				'checkboxgroup' => 'start',
				'desc_tip'      => __( 'Disable all restrictions created in the tab sections above.', 'woocommerce-conditional-shipping-and-payments' ),
			),

			array(
				'title'         => __( 'Disable Product Restrictions', 'woocommerce-conditional-shipping-and-payments' ),
				'desc'          => __( 'Disable all restrictions defined at product level', 'woocommerce-conditional-shipping-and-payments' ),
				'id'            => 'wccsp_restrictions_disable_product',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => 'start',
				'desc_tip'      => __( 'Disable all restrictions created from the <strong>Product Data > Restrictions</strong> tab in product pages. Product level restrictions are associated with specific products.', 'woocommerce-conditional-shipping-and-payments' ),
			),

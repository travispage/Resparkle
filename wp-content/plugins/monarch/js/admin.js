	...
	$( document ).ready( function() {
		...
		$.ajax({
				...
				beforeSend: function ( xhr ){
					$( '.et_social_stats_container .spinner' ).css( 'display', 'block' );
				},
				success: function( data ){
					$( '.et_social_stats_container .spinner' ).css( 'display', 'none' );
		...
		$( '#et_social_stats_container' ).on( 'mouseenter', '.et_social_hover_item', function(){
			var $this_el = $( this );
		...
		$( '#et_social_shortcode_button' ).click( function(){
			...
			$.ajax({
					...
					beforeSend: function ( xhr ){
						$spinner_shortcode.css( "display", "block" );
					},
					success: function( data ){
						$spinner_shortcode.css( "display", "none" );
		...
		$( '.et_social_form' ).on( 'click', '.et_authorize_api', function() {
			var $this_el = $(this).parent(),
				...
				if ( 'Twitter' == network_name ) {
					var api_key = $this_el.parent().find( '.input .api_option_api_key' ).val(),
						api_secret = $this_el.parent().find( '.input .api_option_api_secret' ).val(),
			...
			$.ajax({
					...
					beforeSend: function (){
						$this_el.find( '.spinner' ).css( 'display', 'block' );
					},
					success: function( data ){
						$this_el.find( '.spinner' ).css( 'display', 'none' );

...
<div class="nav stuck" id="main-nav">
	<ul>
		...
		<li>						
			<a href="<?php echo $blog_url;?>shop">
				<span class="icon-shop"></span>
				<strong>SHOP</strong>
			</a>
	        <div class="sub-menu">
	            <ul>	            	
	                <li><a href="<?php echo $blog_url;?>shop">SHOP ONLINE</a></li>
		...
		<li>						
			<a href="<?php echo $blog_url;?>about-us">
	         ...
	         <ul class="sub-menu">
	            ...
	            <li><a href="<?php echo $blog_url.'about-us/news-events/';?>">News &amp; Events</a></li>
	            <li><a href="https://resparkleaustralia.wordpress.com" target="_blank">Blog</a></li>
	        </ul>
		</li>
		<li>
		...
		<li>
	        ...
	        <ul class="sub-menu">            
	            ...
	            <li><a href="<?php echo get_bloginfo('url').'/contact/wholesalers-distributors';?>">Wholesalers / &nbsp;&nbsp;&nbsp;&nbsp;Distributors</a></li>            
	            <li><a href="<?php echo get_bloginfo('url').'/contact/bloggers-affiliates';?>">Bloggers / &nbsp;&nbsp;&nbsp;&nbsp;Affiliates</a></li>
